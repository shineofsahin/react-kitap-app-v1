...
const Admin = ({ history }) => {
  ...
  const loadProfile = () => {
    ...
    axios
      ...
      .catch(err => {
        toast.error(`Bilgi hatası ${err.response.statusText}`);
          ...
          <div className='mt-12 flex flex-col items-center'>
            ...
            >
              <div className='mx-auto max-w-xs relative '>
                <input
                  ...
                  className='w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-400 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-500 focus:bg-white'
                  type='text'
                  placeholder='Rol'
                  disabled
                  value={role}
                />
                <input
                  className='w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-400 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-500 focus:bg-white mt-5'
                  type='email'
                  placeholder='E-posta'
                  disabled
                  value={email}
                />
                <input
                  className=' text-gray-800 w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-400 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-500 focus:bg-white mt-5'
                  type='text'
                  placeholder='Ad'
                ...
                <button
                  type='submit'
                  className='mt-5 tracking-wide font-semibold bg-yellow-600 text-gray-100 w-full py-4 rounded-lg hover:bg-yellow-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none'
                >
           ...
           bg-yellow-600 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-5'
                ...
                >
                  ...
                  <span className='ml-4'>Pörtfoy sistemi</span>
                </a>
              </div>
            </form>
          </div>
